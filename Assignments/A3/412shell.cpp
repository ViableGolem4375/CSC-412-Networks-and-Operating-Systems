...
void do_fork(const ParsedCommand& command) {
    ...
    pid_t pid = fork(); // TODO 1: Use 'fork' to create a child process
    ...
    if (pid == -1) {
        ...
        // TODO 2: Handle child process case
        // Redirect file descriptors if necessary
        // Example: dup2(new_fd, old_fd);
        ...
        // TODO 3: Handle parent process case
        int status;
